...
sa = Slider(axa, 'mi1', -10, 10, valinit=mi, valstep=.1)
sb = Slider(axb, 'std1', 0, 10, valinit=std, valstep=.1)
sc = Slider(axc, 'mi2', -10, 10, valinit=mi2, valstep=.1)
sd = Slider(axd, 'std2', -10, 10, valinit=std2, valstep=.1)
